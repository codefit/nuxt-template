...
export const PLUGINS: PluginMeta[] = [
  ...
  { id: 'button-group', label: 'Button Group', icon: 'i-lucide-panels-top-left', description: 'Více tlačítek vedle sebe', group: 'basic' },
  ...
  { id: 'video', label: 'Video', icon: 'i-lucide-video', description: 'Lokální video (session)', group: 'media' },
